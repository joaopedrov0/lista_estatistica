...
#
# Média: O pico da curva está exatamente entre 640 e 660.
#   Média (µ) = 650
#
# Desvio Padrão Estimado:
#   A maior parte da curva (cerca de 95%) parece estar entre 600 e 700.
#   A largura desse intervalo é 700 - 600 = 100.
#   Este intervalo corresponde a 4 desvios padrão (de -2σ a +2σ).
#   Desvio Padrão (σ) ≈ 100 / 4 = 25.
#
# Resultado obtido: Média de 650 e desvio padrão estimado de 25.
# ============================================================================== #
# 3.a. 
